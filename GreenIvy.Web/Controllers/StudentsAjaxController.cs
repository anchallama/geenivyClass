...
namespace GreenIvy.Web.Controllers
{
    public class StudentsAjaxController : Controller
    {
        ...
        // GET: StudentsAjax/Create
        public ActionResult Create()
        {
            return PartialView();
        }

        // POST: StudentsAjax/Create
